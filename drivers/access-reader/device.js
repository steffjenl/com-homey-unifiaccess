...
module.exports = class Reader extends Homey.Device {
    ...
    onTouchPassConfigChange(value) {
        this.setCapabilityValue('reader_touch-pass_enabled', value);
    }

    onNfcConfigChange(value) {
        this.setCapabilityValue('reader_nfc_enabled', value);
    }

    onWaveConfigChange(value) {
        this.setCapabilityValue('reader_wave_enabled', value);
    }
